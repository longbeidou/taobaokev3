<li class="mui-table-view-cell">
    <div class="mui-row">
        <div class="mui-col-xs-3" style="padding-right: 5px;">
            <img src="/storage/wx/images/app_logo.png" alt="{{ env('SITE_NAME') }}APPlogo" style="width: 100%;">
        </div>
        <div class="mui-col-xs-7">
            <h5 style="margin-top: 0px; margin-bottom: 3px;"><strong>{{ env('SITE_NAME') }}（安卓版）</strong></h5>
        ...
        <div class="mui-col-xs-9">
          <p style="font-size: 12px;">{{ env('SITE_NAME') }}APP是一个时尚购物的APP，免费分享全网最全最优的淘宝天猫优惠券。</p>
        </div>
    </div>
</li>
<li class="mui-table-view-cell">
    <div class="mui-row">
        <div class="mui-col-xs-3" style="padding-right: 5px;">
            <img src="/storage/wx/images/app_logo.png" alt="{{ env('SITE_NAME') }}优惠券logo" style="width: 100%;">
        </div>
        <div class="mui-col-xs-7">
            <h5 style="margin-top: 0px; margin-bottom: 3px;"><strong>{{ env('SITE_NAME') }}（IOS版）</strong></h5>
