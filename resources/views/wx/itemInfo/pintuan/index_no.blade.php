...
@include('wx.itemInfo.pintuan._footer_no')
    ...
    <div class="mui-col-xs-12 lbd-goods-desc">
      ...
      <div class="lbd-bottom">
        <div class="lbd-left mui-pull-left">
          ...
          <span class="lbd-price-ori" style="text-decoration: none;">单买价￥{{ number_format($itemInfo->zk_final_price, 2) }}</span>
        </div>
        <div class="lbd-right mui-pull-right">{{ $itemInfo->volume }}人完成拼团</div>
      </div>
    </div>
  </div><!--商品介绍 结束-->
      @include('wx.itemInfo.pintuan._pintuan_info_no')
  <!--店铺信息 开始-->
