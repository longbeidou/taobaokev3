              ...
              <form class="form-horizontal" method="post" action="{{ route('admin.couponRule.store') }}" target="_self" enctype="multipart/form-data">
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <div class="col-sm-9">
                              <input type="text" name="cat" value="{{ old('cat') }}" class="form-control" placeholder="请输入后台类目ID">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9">
                              <input type="number" name="page_size" required class="form-control" value="20" min="1" max="100" step="1" placeholder="页大小">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9">
                              <input type="text" name="q" required value="{{ old('q') }}" class="form-control" placeholder="请输入查询词">
                          </div>
                      </div>
                  </div>
